...
After all components are rendered, the extension SHALL resize the SVG document to fit the bounding box of all rendered elements plus a margin.

#### Scenario: Document with rendered VPCs
- **WHEN** one or more VPCs have been rendered
