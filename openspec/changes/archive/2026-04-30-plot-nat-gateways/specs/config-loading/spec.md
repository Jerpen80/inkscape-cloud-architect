...
The default config SHALL include a `document` section with a `margin` key and a `layout` section with account, vpc, subnet, availability_zone, region, ec2, database, load_balancer, s3, and nat_gateway spacing values.
