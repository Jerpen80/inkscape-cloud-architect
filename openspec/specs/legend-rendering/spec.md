...
### Requirement: Legend border and title
The legend SHALL be enclosed in a bordered rectangle with a "Legend" title label.

#### Scenario: Legend rect
- **WHEN** the legend is rendered
- **THEN** a border rectangle SHALL enclose all legend content with padding

#### Scenario: Legend title
- **WHEN** the legend is rendered
- **THEN** a "Legend" text label SHALL appear at the top-left of the border rectangle
